...
if __name__ == '__main__':
    ...
    parser.add_argument('--top_k', type=int, default=2, help='FFT top k')
    ...
    parser.add_argument('--mlp_layers', type=int, default=3, help='num of mlp layers')
    ...
    args.root_path = os.path.join("dataset", args.root_path)
